...
var DashboardActions = function () {
    function DashboardActions() {
        ...
        this.generateActions("getUsersSuccess", "getUsersFailed", 'getHeatMapDataSuccess', 'getHeatMapDataFailed', "getBarChartDataSuccess", "getBarChartDataFailed", "getBubbleChartDataSuccess", "getBubbleChartDataFailed", "getLineChartDataSuccess", "getLineChartDataFailed");
    }

    _createClass(DashboardActions, [{
        key: "getUsers",
        value: function getUsers(target, filters) {
            var _this = this;
            ...
            $.ajax({ url: url, data: params }).done(function (data) {
                ...
                _this.actions.getUsersFailed(jqXhr);
            });
        }
    }, {
        key: "getHeatMapData",
        value: function getHeatMapData(target, filters) {
            var _this2 = this;

            var url = '/api/heatMapData';
            var params = {
                type: target,
                filters: filters
            };
            $.ajax({ url: url, data: params }).done(function (data) {
                _this2.actions.getHeatMapDataSuccess(data);
            }).fail(function (jqXhr) {
                _this2.actions.getHeatMapDataFailed(jqXhr);
            });
        }
    }, {
        key: "getBarChartData",
        value: function getBarChartData(target, filters) {
            var _this3 = this;

            var url = '/api/barChartData';
            var params = {
                type: target,
                filters: filters
            };
            $.ajax({ url: url, data: params }).done(function (data) {
                _this3.actions.getBarChartDataSuccess(data);
            }).fail(function (jqXhr) {
                _this3.actions.getBarChartDataFailed(jqXhr);
            });
        }
    }, {
        key: "getBubbleChartData",
        value: function getBubbleChartData(target, filters) {
            var _this4 = this;

            var url = '/api/bubbleChartData';
            var params = {
                type: target,
                filters: filters
            };
            $.ajax({ url: url, data: params }).done(function (data) {
                _this4.actions.getBubbleChartDataSuccess(data);
            }).fail(function (jqXhr) {
                _this4.actions.getBubbleChartDataFailed(jqXhr);
            });
        }
    }, {
        key: "getLineChartData",
        value: function getLineChartData(target, filters) {
            var _this5 = this;

            var url = '/api/lineChartData';
            var params = {
                type: target,
                filters: filters
            };
            $.ajax({ url: url, data: params }).done(function (data) {
                _this5.actions.getLineChartDataSuccess(data);
            }).fail(function (jqXhr) {
                _this5.actions.getLineChartDataFailed(jqXhr);
            });
        }
    }]);
...
var LogActions = function () {
    function LogActions() {
        _classCallCheck(this, LogActions);

        this.generateActions("getUsersSuccess", "getUsersFailed", 'getLogsSuccess', 'getLogsFailed');
    }

    _createClass(LogActions, [{
        key: "getUsers",
        value: function getUsers(target, filters) {
            var _this = this;
        ...
        key: "getLogs",
        value: function getLogs(target, filters) {
            var _this2 = this;
            ...
            $.ajax({ url: url, data: params }).done(function (data) {
                _this2.actions.getLogsSuccess(data);
            }).fail(function (jqXhr) {
                _this2.actions.getLogsFailed(jqXhr);
            });
        }
    }]);
...
exports.default = _alt2.default.createActions(LogActions);
...
var MainActions = function () {
    function MainActions(props) {
        ...
        this.generateActions('gotoWhere');
    }

    _createClass(MainActions, [{
        key: 'gotoView',
        value: function gotoView(target) {
...
var _MainActions = require('../actions/MainActions');
...
var Main = function (_React$Component) {
  ...
  function Main(props) {
    ...
    _this.state = _MainStore2.default.getState();
...
var App = function (_React$Component2) {
  ...
  function App(props) {
    ...
    _this2.state = _MainStore2.default.getState();
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      _MainStore2.default.listen(this.onChange);
      _MainActions2.default.gotoWhere();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _MainStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    ...
    key: 'onChangeView',
    value: function onChangeView(target) {
      _MainActions2.default.gotoView(target);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      if (this.state.view == "dashboard" || this.state.view == "" || !this.state.view) {
        currentView = _react2.default.createElement(_Dashboard2.default, null);
      }
      ...
      if (this.state.view == "logs_users" || this.state.view == "logs_files") {
        ...
        currentView = _react2.default.createElement(_Log2.default, logProps);
      }
...
},{"../actions/MainActions":3,"../stores/MainStore":19,"./Dashboard":6,"./Header":7,"./Log":9,"./Sidebar":10,"react":"react"}],6:[function(require,module,exports){
'use strict';
...
var Dashboard = function (_React$Component) {
    ...
    function Dashboard(props) {
        ...
        _this.state = _DashboardStore2.default.getState();
        _this.onChange = _this.onChange.bind(_this);
    ...
    _createClass(Dashboard, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            _DashboardStore2.default.listen(this.onChange);
            _DashboardActions2.default.getUsers(this.state.filters);
            _DashboardActions2.default.getHeatMapData(this.state.filters);
            _DashboardActions2.default.getBarChartData(this.state.filters);
            _DashboardActions2.default.getBubbleChartData(this.state.filters);
            _DashboardActions2.default.getLineChartData(this.state.filters);
        }
    }, {
        key: 'componentWillUnmount',
        value: function componentWillUnmount() {
            _DashboardStore2.default.unlisten(this.onChange);
        }
    }, {
        ...
        value: function componentDidUpdate(prevState) {
            if (JSON.stringify(prevState.filter) != JSON.stringify(this.state.filter)) {
                _DashboardActions2.default.getUsers(this.state.filters);
                _DashboardActions2.default.getHeatMapData(this.state.filers);
                _DashboardActions2.default.getBarChartData(this.state.filers);
                _DashboardActions2.default.getBubbleChartData(this.state.filters);
                _DashboardActions2.default.getLineChartData(this.state.filters);
            }
        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'section',
                { id: 'dashboard', className: 'mainPanel' },
                _react2.default.createElement(_HeaderBar2.default, headerBarProps),
                _react2.default.createElement(
                    'div',
                    { id: 'dsPanel', className: 'mainPanelBody' },
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(_HeatMap2.default, chartProps)
                                ),
                                _react2.default.createElement(
                                    'div',
                                    { className: 'content' },
                                    _react2.default.createElement(
                                        'a',
                                        { className: 'header' },
                                        'User Activity Heatmap (Time Based)'
                                    )
                                )
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'image chart ' },
                                    _react2.default.createElement(_BarChart2.default, chartProps)
                                ),
                                _react2.default.createElement(
                                    'div',
                                    { className: 'content' },
                                    _react2.default.createElement(
                                        'a',
                                        { className: 'header' },
                                        'Activity Calculation Chart (User Based)'
                                    )
                                )
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'image chart' },
                                    _react2.default.createElement(_BubbleChart2.default, chartProps)
                                ),
                                _react2.default.createElement(
                                    'div',
                                    { className: 'content' },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'image chart' },
                                    _react2.default.createElement(_LineChart2.default, chartProps)
                                ),
                                _react2.default.createElement(
                                    'div',
                                    { className: 'content' },
...
},{"../actions/DashboardActions":1,"../stores/DashboardStore":17,"./HeaderBar":8,"./charts/BarChart":11,"./charts/BubbleChart":12,"./charts/HeatMap":13,"./charts/LineChart":14,"react":"react"}],7:[function(require,module,exports){
"use strict";
...
var HeaderBar = function (_React$Component) {
    ...
    _createClass(HeaderBar, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { id: "dsHeader", className: "mainPanelHeader" },
                _react2.default.createElement(
                    "div",
                    { className: "ui  menu" },
                    _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "div",
                            { className: "ui primary button", onClick: this.handleClickGo.bind(this) },
                            "Go"
                        )
                    )
                )
...
var _LogStore = require('../stores/LogStore');

var _LogStore2 = _interopRequireDefault(_LogStore);

var _LogActions = require('../actions/LogActions');
...
var Log = function (_React$Component) {
    ...
    function Log(props) {
        ...
        _this.state = _LogStore2.default.getState();
        _this.onChange = _this.onChange.bind(_this);
        return _this;
    }
    ...
    _createClass(Log, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            _LogStore2.default.listen(this.onChange);
            _LogActions2.default.getLogs(this.state.filters);
            _LogActions2.default.getUsers(this.state.users);
        }
    }, {
        key: 'componentWillUnmount',
        value: function componentWillUnmount() {
            _LogStore2.default.unlisten(this.onChange);
        }
    }, {
        key: 'componentDidUpdate',
        value: function componentDidUpdate(prevState) {
            if (JSON.stringify(prevState.filter) != JSON.stringify(this.state.filter)) {
                _LogActions2.default.getLogs(this.state.filers);
                _LogActions2.default.getUsers(this.state.users);
            }
        }
    }, {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'section',
                { id: 'log', className: 'mainPanel' },
                _react2.default.createElement(_HeaderBar2.default, headerBarProps),
                _react2.default.createElement(
                    'div',
                    { id: 'logTable', className: 'mainPanelBody' },
                    _react2.default.createElement(
                        'table',
...
},{"../actions/LogActions":2,"../stores/LogStore":18,"./HeaderBar":8,"react":"react"}],10:[function(require,module,exports){
'use strict';
...
var Sidebar = function (_React$Component) {
    ...
    _createClass(Sidebar, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'section',
                { id: 'sidebar', className: 'ui visible sidebar' },
                _react2.default.createElement(
                    'div',
                    { id: 'it', className: 'ui vertical icon menu' },
                    _react2.default.createElement(
                        'a',
                        { className: 'item', id: 'side_dsb', onClick: this.handleClick.bind(this) },
                        _react2.default.createElement('i', { className: 'block layout icon' }),
                        'Dashboard'
                    ),
                    _react2.default.createElement(
                        _reactRouter.Link,
                        { id: 'link_dsb', to: '/dashboard' },
                        ' '
                    ),
                    _react2.default.createElement(
                        'a',
                        { className: 'item', id: 'side_users', onClick: this.handleClick.bind(this) },
                        _react2.default.createElement('i', { className: 'table icon' }),
                        'Logs'
                    ),
                    _react2.default.createElement(
                        'a',
                        { className: 'item', id: 'side_rep', onClick: this.handleClick.bind(this) },
                        _react2.default.createElement('i', { className: 'doctor icon' }),
                        'User Activity Analysis'
                    )
                ),
                _react2.default.createElement('div', { className: 'pusher' })
            );
        }
    }]);
...
},{"react":"react","react-router":"react-router","react-router-redux":65,"redux":74}],11:[function(require,module,exports){
'use strict';
...
var BarChart = function (_React$Component) {
    ...
    function BarChart(props) {
        ...
        _this.data = _this.props.barChartData;
        return _this;
    }
    ...
    _createClass(BarChart, [{
        ...
        value: function componentDidMount() {
            ...
            if (data.length != 0) {
                ...
                var color = function color(i) {
                    var scheme = ["#2171b5", "#6baed6", "#bdd7e7", "#eff3ff", "#d94701", "#fd8d3c", "#fdbe85", "#feedde", "#edf8e9", "#bae4b3", "#74c476", "#238b45", "#6a51a3", "#9e9ac8", "#cbc9e2", "#f2f0f7"];
                    return scheme[i];
                };
                ...
                var chart = d3.select("#barchart").attr("width", spaceForLabels + chartWidth + spaceForLegend).attr("height", chartHeight);
        ...
        key: 'render',
        value: function render() {
            var div = new _reactFauxDom2.default.createElement('div');
            div.appendChild(_react2.default.createElement('svg', { className: 'barchart', id: 'barchart' }));
            return div.toReact();
        }
    }]);
...
},{"d3":20,"react":"react","react-faux-dom":54}],12:[function(require,module,exports){
'use strict';
...
var BubbleChart = function (_React$Component) {
    ...
    function BubbleChart(props) {
        ...
        _this.data = _this.props.bubbleChartData;
        return _this;
    }
    ...
    _createClass(BubbleChart, [{
        ...
        value: function componentDidMount() {
            ...
            var svg = d3.select(".bubblechart").append("svg").attr("width", diameter).attr("height", diameter).attr("class", "bubble");
        ...
        value: function render() {
            var div = new _reactFauxDom2.default.createElement('div');
            div.appendChild(_react2.default.createElement('div', { className: 'bubblechart' }));
            return div.toReact();
        }
    }]);
...
},{"d3":20,"react":"react","react-faux-dom":54}],13:[function(require,module,exports){
'use strict';
...
var HeatMap = function (_React$Component) {
    ...
    function HeatMap(props) {
        ...
        _this.data = _this.props.heatMapData;
    ...
    _createClass(HeatMap, [{
        ...
        value: function componentDidMount() {
            ...
            var dayFormat = function dayFormat(date) {
                var date = new Date(date);
                //console.log(date.getDate());
                return date.getDate();
            };
            var hourFormat = function hourFormat(date) {
                var date = new Date(date);
            ...
            var monthDayFormat = function monthDayFormat(date) {
                var date = new Date(date);
            ...
            var axisWidth = 0,
                ...
                xAxis = d3.axisTop().ticks(d3.timeDay.every(4)).tickFormat(d3.timeFormat('%m.%d')),
                yAxisScale = d3.scaleLinear().range([0, axisHeight]).domain([0, 24]),
                yAxis = d3.axisLeft().ticks(5).tickFormat(d3.format('02d')).scale(yAxisScale);
            ...
            rect = heatmap.selectAll('rect').data(this.data).enter().append('rect').attr('width', cellSize).attr('height', cellSize).attr('x', function (d) {
            ...
            function renderColor() {
                ...
                rect.filter(function (d) {
                    ...
                    var colorIndex = d3.scaleQuantize().range([0, 1, 2, 3, 4, 5]).domain(renderByCount ? [0, 500] : dailyValueExtent[d.day]);
        ...
        value: function render() {
            var div = new _reactFauxDom2.default.createElement('div');
            div.appendChild(_react2.default.createElement(
                'div',
                { className: 'days-hours-heatmap' },
                _react2.default.createElement(
                    'div',
                    { className: 'calibration', role: 'calibration' },
                    _react2.default.createElement(
                        'div',
                        { className: 'group', role: 'example' },
                        _react2.default.createElement('svg', { width: '120', height: '17' }),
                        _react2.default.createElement(
                            'div',
                            { role: 'description', className: 'description' },
                            _react2.default.createElement(
                                'label',
                                null,
                                'Less'
                    ...
                    _react2.default.createElement(
                        'div',
                        { role: 'toggleDisplay', className: 'display-control' },
                        _react2.default.createElement(
                            'div',
                            null,
                            _react2.default.createElement('input', { type: 'radio', name: 'displayType', checked: true }),
                            _react2.default.createElement(
                                'label',
                                null,
                                'count'
                        ...
                        _react2.default.createElement(
                            'div',
                            null,
                            _react2.default.createElement('input', { type: 'radio', name: 'displayType' }),
                            _react2.default.createElement(
                                'label',
                                null,
                                'daily'
                ...
                _react2.default.createElement('svg', { role: 'heatmap', className: 'heatmap' })
            ));
            return div.toReact();
        }
    }]);
...
},{"d3":20,"react":"react","react-faux-dom":54}],14:[function(require,module,exports){
'use strict';
...
var LineChart = function (_React$Component) {
    ...
    function LineChart(props) {
        ...
        _this.data = _this.props.lineChartData;
        return _this;
    }
    ...
    _createClass(LineChart, [{
        ...
        value: function componentDidMount() {
            ...
            if (data.length != 0) {
                ...
                y.domain([d3.min(users, function (c) {
                    return d3.min(c.values, function (d) {
                        return d.count;
                    });
                }), d3.max(users, function (c) {
                    return d3.max(c.values, function (d) {
                        return d.count;
                    });
                })]);

                z.domain(users.map(function (c) {
                    return c.id;
                }));

                g.append("g").attr("class", "axis axis--x").attr("transform", "translate(0," + height + ")").call(d3.axisBottom(x));

                g.append("g").attr("class", "axis axis--y").call(d3.axisLeft(y)).append("text").attr("transform", "rotate(-90)").attr("y", 6).attr("dy", "0.71em").attr("fill", "#000").text("count, #");

                var city = g.selectAll(".city").data(users).enter().append("g").attr("class", "city").style("fill", "none");
        ...
        value: function render() {
            var div = new _reactFauxDom2.default.createElement('div');
            div.appendChild(_react2.default.createElement('svg', { className: 'linechart', id: 'linechart' }));
            return div.toReact();
        }
    }]);
...
},{"d3":20,"react":"react","react-faux-dom":54}],15:[function(require,module,exports){
'use strict';
...
},{"./routes":16,"history/lib/createBrowserHistory":29,"react":"react","react-dom":"react-dom","react-router":"react-router"}],16:[function(require,module,exports){
'use strict';
...
},{"./components/App":5,"./components/Dashboard":6,"react":"react","react-router":"react-router"}],17:[function(require,module,exports){
'use strict';
...
var DashboardStore = function () {
    function DashboardStore(props) {
        ...
        this.bindActions(_DashboardActions2.default);
        this.users = [];
        this.filters = [];
        this.heatMapData = [];
        this.barChartData = [];
    ...
    _createClass(DashboardStore, [{
        ...
        key: 'onGetUsersFailed',
        value: function onGetUsersFailed(jqXhr) {
            toastr.error(jqXhr.responseJSON.message);
        }
    }, {
        key: 'onGetHeatMapDataSuccess',
        value: function onGetHeatMapDataSuccess(data) {
            this.heatMapData = data.data;
        }
    }, {
        key: 'onGetHeatMapDataFailed',
        value: function onGetHeatMapDataFailed(jqXhr) {
            toastr.error(jqXhr.responseJSON.message);
        }
    }, {
        key: 'onGetBarChartDataSuccess',
        value: function onGetBarChartDataSuccess(data) {
            this.barChartData = data;
        }
    }, {
        key: 'onGetBarChartDataFailed',
        value: function onGetBarChartDataFailed(jqXhr) {
            toastr.error(jqXhr.responseJSON.message);
        }
    }, {
        key: 'onGetBubbleChartDataSuccess',
        value: function onGetBubbleChartDataSuccess(data) {
            this.bubbleChartData = data;
        }
    }, {
        key: 'onGetBubbleChartDataFailed',
        value: function onGetBubbleChartDataFailed(jqXhr) {
            toastr.error(jqXhr.responseJSON.message);
        }
    }, {
        key: 'onGetLineChartDataSuccess',
        value: function onGetLineChartDataSuccess(data) {
            this.lineChartData = data;
        }
    }, {
        key: 'onGetLineChartDataFailed',
        value: function onGetLineChartDataFailed(jqXhr) {
            toastr.error(jqXhr.responseJSON.message);
        }
    }]);
...
exports.default = _alt2.default.createStore(DashboardStore);

},{"../actions/DashboardActions":1,"../alt":4}],18:[function(require,module,exports){
'use strict';
...
var LogStore = function () {
    function LogStore(props) {
        _classCallCheck(this, LogStore);

        this.bindActions(_LogActions2.default);
        this.users = [];
        this.filters = [];
        this.logs = [];
    }
    ...
    _createClass(LogStore, [{
        ...
        key: 'onGetLogsFailed',
        value: function onGetLogsFailed(jqXhr) {
            toastr.error(jqXhr.responseJSON.message);
        }
    }]);
...
exports.default = _alt2.default.createStore(LogStore);

},{"../actions/LogActions":2,"../alt":4}],19:[function(require,module,exports){
'use strict';
...
var MainStore = function () {
    ...
    _createClass(MainStore, [{
        key: 'onGotoWhere',
        value: function onGotoWhere(target) {
            this.view = target;
        }
    }]);
...
},{"../actions/MainActions":3,"../alt":4}],20:[function(require,module,exports){
...
},{"_process":48,"warning":80}],27:[function(require,module,exports){
'use strict';
...
},{"./Actions":24,"./DOMStateStorage":26,"./DOMUtils":27,"./ExecutionEnvironment":28,"./createDOMHistory":30,"./parsePath":35,"_process":48,"invariant":37}],30:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./DOMUtils":27,"./ExecutionEnvironment":28,"./createHistory":31,"_process":48,"invariant":37}],31:[function(require,module,exports){
...
module.exports = exports['default'];
},{"./Actions":24,"./AsyncUtils":25,"./createLocation":32,"./deprecate":33,"./parsePath":35,"./runTransitionHook":36,"deep-equal":21}],32:[function(require,module,exports){
//import warning from 'warning'
'use strict';
...
},{"./extractPath":34,"_process":48,"warning":80}],36:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":48,"warning":80}],37:[function(require,module,exports){
(function (process){
/**
...
},{"_process":48}],38:[function(require,module,exports){
...
},{"./lib/query-selector":50}],50:[function(require,module,exports){
/**
 * @ignore
 ...
 *  - http://sizzlejs.com/
 */
},{"./query-selector/parser":51,"./query-selector/util":52}],51:[function(require,module,exports){
/*
  Generated by kison.*/
...
},{"./utils/assign":58,"./utils/camelCase":59,"./utils/isString":60,"./utils/isUndefined":61,"./utils/mapValues":62,"./utils/styleCamelCase":63,"query-selector":49,"react":"react","style-attr":76}],54:[function(require,module,exports){
...
},{"./Element":53,"./Window":55,"./mixins/anim":56,"./mixins/core":57}],55:[function(require,module,exports){
var Window = {
...
},{"../Element":53,"../utils/mapValues":62}],58:[function(require,module,exports){
...
},{"./camelCase":59}],64:[function(require,module,exports){
'use strict';
...
},{"./createStore":73,"./utils/warning":75,"_process":48,"lodash/isPlainObject":47}],72:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":47,"symbol-observable":77}],74:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":69,"./bindActionCreators":70,"./combineReducers":71,"./compose":72,"./createStore":73,"./utils/warning":75,"_process":48}],75:[function(require,module,exports){
'use strict';
